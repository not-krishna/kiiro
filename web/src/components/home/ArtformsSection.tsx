    ...
    <section id="artforms" className="bg-[#FBF9F4] border-b border-[#E8E1D5] py-20 md:py-28 px-6 md:px-10">
      <div className="max-w-7xl mx-auto space-y-10">
        <div className="max-w-3xl space-y-4">
          <h2 className="font-display text-fluid-3xl font-normal">The practices themselves</h2>
        ...
        <div className="grid lg:grid-cols-12 gap-10 border-t border-[#E8E1D5] pt-10">
          <div className="lg:col-span-5 space-y-4">
            ...
            <Link
              href={chapter.href}
              className="inline-block text-[15px] font-medium border-b-2 border-[#2B231F] pb-1 hover:text-[#C2593F] hover:border-[#C2593F]"
            >
              Browse this pillar
            </Link>
          </div>
          <div className="lg:col-span-7">
            <p className="text-sm text-[#6E635B] mb-4">Workshops in this pillar</p>
            <ul className="grid sm:grid-cols-2 gap-px bg-[#E8E1D5] border border-[#E8E1D5]">
              {related.map((workshop) => (
                <li key={workshop.slug} className="bg-[#FBF9F4] p-5">
                  <p className="font-display text-lg text-[#2B231F]">{workshop.name}</p>
