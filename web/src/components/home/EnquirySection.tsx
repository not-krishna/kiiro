    ...
    <section id="enquiry" className="bg-[#F3EFE6] text-[#2B231F] border-b border-[#E8E1D5] py-20 md:py-28 px-6 md:px-10">
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <span className="inline-block text-xs uppercase tracking-[0.2em] text-[#C2593F] font-semibold" data-motion-reveal data-motion-distance="14">Get Started</span>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch" data-motion-stagger>
          <article className="bg-[#2B231F] text-[#FBF9F4] p-8 sm:p-10 md:p-12 flex flex-col justify-between border border-[#3D332E] shadow-sm relative group hover:border-[#C2593F] transition-all duration-300" data-motion-item data-motion-card>
            ...
            <div className="pt-8 mt-6 border-t border-[#3D332E]">
              <Link
                ...
                className="kiiro-cta w-full sm:w-auto inline-flex min-h-12 items-center justify-center px-7 py-3.5 bg-[#C2593F] text-white font-sans text-[15px] font-medium tracking-normal hover:bg-[#A84A33] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C2593F]"
              >
